...
usama = Account.new({ email: 'usama.arshad@devsinc.com', full_name: 'Usama Arshad',
                      username: 'usama arshad', is_private: true, password: '123456789', password_confirmation: '123456789' })
...
hassan = Account.new({ email: 'hassan.raza@devsinc.com', full_name: 'Hassan Raza',
                       username: 'hassan raza', is_private: true, password: '123456789', password_confirmation: '123456789' })
hassan.save(validate: false)
post2 = Post.new(description: 'First Post', account_id: hassan.id)
post2.images.attach(io: File.open("#{Rails.root}/app/assets/images/Ruby.jpg"), filename: 'download.jpeg')
post2.save
